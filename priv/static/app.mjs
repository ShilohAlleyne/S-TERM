...
function figcaption(attrs, children2) {
  return element("figcaption", attrs, children2);
}
...
function update(model, msg) {
  if (msg instanceof KeyPress) {
    ...
    let value3 = msg[0];
    return [model.withFields({ command: value3 }), none()];
  } else {
    return [model.withFields({ output: "" }), none()];
  }
}
function view(model) {
  let header = toList([
      ...
      div(
        ...
        toList([
          div(
            toList([
              class$(
                "p-5 h-full w-full overflow-y-auto box-border border-2 border-purple-800"
              )
            ]),
            toList([
              figure(
                toList([class$("Consolas text-purple-500")]),
                toList([
                  pre(toList([]), toList([text(join2(header, "\n"))])),
                  figcaption(
                    toList([class$("Consolas text-purple-400 drop-shadow-glow")]),
              ...
              pre(
                toList([class$("Consolas text-purple-500"), id("output")]),
                toList([text(model.output)])
              ),
              div(
                toList([class$("flex")]),
                toList([
                  div(
                    toList([class$("flex-none py-2")]),
                    toList([
                      span(
                        toList([class$("Consolas text-purple-300")]),
                        toList([text("@runner \u2192 ")])
                      ),
                      span(
                        toList([class$("Consolas text-purple-400")]),
                        toList([text("~/shiloh_alleyne/cv ")])
                      ),
                      span(
                        toList([class$("Consolas text-purple-300")]),
                        toList([text("\u26A1\uFE0Emain \u2771")])
                  ...
                  input(
                    toList([
                      ...
                      autofocus(true),
                      class$(
                        "flex-auto px-2 w-full Consolas text-purple-500 bg-transparent border-none focus:outline-none"
                      )
                    ])
                  )
                ])
